...
void PlikZUzytkownikami::dopiszUzytkownikaDoPliku(Uzytkownik uzytkownik)
{
    ...
    if (plikTekstowy.good() == true)
    {
        ...
        cout << "Nie udalo sie otworzyc pliku " << getNazwaPliku() << " i zapisac w nim danych." << endl;
    plikTekstowy.close();
}
...
void PlikZUzytkownikami::zapiszWszystkichUzytkownikowDoPliku(vector <Uzytkownik> uzytkownicy)
{
    ...
    plikTekstowy.open(getNazwaPliku().c_str(), ios::out|ios::trunc);
    ...
    {
        cout << "Nie mozna otworzyc pliku " << getNazwaPliku() << endl;
    }
    plikTekstowy.close();
}
