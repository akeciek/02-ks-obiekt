...
void PlikZAdresatami::edytujAdresata(int idZalogowanegoUzytkownika)
{
    ...
    {
        if (adresaci[i].pobierzId() == idEdytowanegoAdresata && adresaci[i].pobierzIdUzytkownika() == idZalogowanegoUzytkownika)
        {
            ...
            case '1':
                ...
                zaktualizujDaneWybranegoAdresata(adresaci[i], nr_linii);
                break;
            case '2':
...
void PlikZAdresatami::zaktualizujDaneWybranegoAdresata(Adresat adresat, int nr_linii)
{
    //int numerLiniiEdytowanegoAdresata = 0;
    string liniaZDanymiAdresata = "";
    liniaZDanymiAdresata = MetodyPomocnicze::zamienDaneAdresataNaLinieZDanymiOddzielonaPionowymiKreskami(adresat);
    edytujWybranaLinieWPliku(nr_linii, liniaZDanymiAdresata);
...
void PlikZAdresatami::edytujWybranaLinieWPliku(int nr_linii, string liniaZDanymiAdresataOddzielonePionowymiKreskami)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true)
    {
        ...
        {
            if (numerWczytanejLinii == nr_linii)
            {
...
void PlikZAdresatami::usunAdresata(int idZalogowanegoUzytkownika)
{
    ...
    for (vector <Adresat>::iterator itr = adresaci.begin(); itr != adresaci.end(); itr++)
    {
        if (itr -> pobierzId() == idUsuwanegoAdresata && itr->pobierzIdUzytkownika() == idZalogowanegoUzytkownika)
        {
            czyIstniejeAdresat = true;
            ...
            if (znak == 't')
            {
                usunWybranaLinieWPliku(nr_linii);
                adresaci.erase(itr);
